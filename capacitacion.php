...
<body>
  ...
  <!-- Main Content -->
 <div class="container">
  <h4 class="text-center"> CAPACITACIONES SICASA </h4>
  <br><br>
...
<div class="row">
      <figure class="col-4">
        <a href="cfdi.php" data-size="1600x1067">
          <img alt="picture" src="img/galeria/cfdi/1.jpg" class="img-fluid">
        </a>   
      </figure>
  <div class="col-8">
        <h5>CFDI Rembolsos</h5>
      <p>el día 4 de Marzo se impartio el curso sobre CDFI Rembolsos.
      </p>
  </div>
</div>
<br>
...
<div class="row">
      <figure class="col-4">
        <a href="extintor.php" data-size="1600x1067">
          <img alt="picture" src="img/galeria/extintor/1.jpg" class="img-fluid">
        </a>   
      </figure>
  <div class="col-8">
        <h5>Manejo De Extintores</h5>
      <p>El día 29 de Febrero se impartió el curso sobre el uso de Extintores.
      </p>
  </div>
</div>
<br>
...
<div class="row">
      <figure class="col-4">
        <a href="gestiontiempo.php" data-size="1600x1067">
          <img alt="picture" src="img/galeria/gestiontiempo/7.jpeg" class="img-fluid">
        </a>   
      </figure>
  <div class="col-8">
        <h5>Gestión del tiempo</h5>
      <p>El dia 5 de Febrero se tomo el curso  enfocado a la toma de decisiones cotidianas, para generar hábitos que simplifiquen las actividades y a su vez generen mayor productividad para el logro de objetivos
      </p>
  </div>
</div>
<br>
