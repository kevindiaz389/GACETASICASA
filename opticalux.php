...
<div class="col">
  ...
  <img src="img/convenios/lux.jpg">
  <br>
  <br>
  <br>
  <p class="intro">
    15 % de descuento en:  auxiliares auditivos, anteojos graduados, lentes de contacto, lentes de contacto, lentes de contacto cosméticos, armazones y anteojos solares.

    <br>
    <br>

    Estos descuentos serán para el personal y familiares directos (padres, cónyuge e hijos) solo en compras de contado.
