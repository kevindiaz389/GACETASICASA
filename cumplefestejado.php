...
<div class="row">
                <figure class="col-3">
       <a class="lightbox" href="img/galeria/cumplefestejados/1.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/cumplefestejados/1.jpg" class="img-fluid">
        </a></figure>
        <figure class="col-3">
        <a class="lightbox" href="img/galeria/cumplefestejados/2.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/cumplefestejados/2.jpg" class="img-fluid">
        </a></figure>
      <figure class="col-3">
       <a class="lightbox" href="img/galeria/cumplefestejados/3.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/cumplefestejados/3.jpg" class="img-fluid">
        </a></figure>
      <figure class="col-3">
       <a class="lightbox" href="img/galeria/cumplefestejados/4.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/cumplefestejados/4.jpg" class="img-fluid">
        </a></figure>
...
<div class="row">
      <figure class="col-3">
        <a class="lightbox" href="img/galeria/cumplefestejados/5.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/cumplefestejados/5.jpg" class="img-fluid">
        </a></figure>
      <figure class="col-3">
       <a class="lightbox" href="img/galeria/cumplefestejados/6.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/cumplefestejados/6.jpg" class="img-fluid">
        </a></figure>
    </div>
