...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  <section>
      <h3>MATERIALES DE REFERENCIA SICASA</h3>
  </section>
  <br><hr><br><br>
  
  <section class="row contenido">
      <div class="col-4"><br><br><br><br><h4>CURSO DE INDUCCION 5s</h4></div>
      <div class=" col-8 embed-responsive embed-responsive-21by9">
      <iframe class="embed-responsive-item" src="videos/5s.mp4"></iframe></div>
  </section>
