...
<!-- Inicia llamando librerias -->
  ...
  <link href="css/flechasanimadas.css" rel="stylesheet">
  <link href="css/cumplemes.css" rel="stylesheet">
...
<h4 class="text-center">CUMPLEAÑEROS DEL MES DE ENERO</h4>
<br><br>
...
<div class="col-11">
              <figure>
                <img src="img/cumple/3.jpeg" class="img-fluid" style="width: 400px; height: 400px;">
              </figure>
            </div>

<div class="col-1">
<div class="elemento">  
  <a title="Saber más!" class="menuPpal suavizado" href="#1"><i class="fa fa-angle-down fa-2x flecha animatedColor" aria-hidden="true"></i> </a>                                
</div>
</div>
</div>
...
<div class="col-11">
              <figure>
                <img src="img/cumple/23.jpeg" class="img-fluid" style="width: 400px; height: 400px;">
              </figure>
            </div>
...
<div class="col-11" id="1">
              <figure>
                <img src="img/cumple/29.jpeg" class="img-fluid" style="width: 400px; height: 400px;">
              </figure>
            </div>

<div class="col-1">
<div class="elemento">  
  <a title="Saber más!" class="menuPpal suavizado" href="#2"><i class="fa fa-angle-down fa-2x flecha animatedColor" aria-hidden="true"></i> </a>                                
</div>
</div>
</div>
