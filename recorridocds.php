...
<div class="row">
                <figure class="col-3">
       <a class="lightbox" href="img/galeria/recorridocds/1.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/recorridocds/1.jpg" class="img-fluid">
        </a></figure>
        <figure class="col-3">
        <a class="lightbox" href="img/galeria/recorridocds/2.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/recorridocds/2.jpg" class="img-fluid">
        </a></figure>
      <figure class="col-3">
       <a class="lightbox" href="img/galeria/recorridocds/3.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/recorridocds/3.jpg" class="img-fluid">
        </a></figure>
      <figure class="col-3">
       <a class="lightbox" href="img/galeria/recorridocds/5.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/recorridocds/5.jpg" class="img-fluid">
        </a></figure>
...
<div class="row">
      <figure class="col-3">
        <a class="lightbox" href="img/galeria/recorridocds/6.jpg" data-size="1600x1067">
          <img alt="picture" src="img/galeria/recorridocds/6.jpg" class="img-fluid">
        </a></figure>
      <figure class="col-3">
       <a class="lightbox" href="img/galeria/recorridocds/7.jpg" data-size="1600x1067">
